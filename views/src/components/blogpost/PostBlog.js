  ...
  return (
      <>
        <div class="container mt-5">
          ...
          <form>
          <input type="text" name="title" class="form-control" placeholder="Enter title here..." required></input>
          <textarea name="content" cols="30" row="10" class="mt-3 form-control" placeholder="Enter content here" required></textarea>
          <input type="text" name="athur" class="mt-3 form-control" placeholder="Name" required></input>
